  ...
  return (
    <section className="container mx-auto py-12 px-4">
      <div className="text-center mb-10">
        <h2 className="text-3xl font-bold mb-3 text-gray-900">Follow Us on Instagram</h2>
        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          Stay updated with our latest products and collections. Tag us with <span className="text-pink-500 font-medium">#OurBrand</span> for a chance to be featured!
        </p>
      </div>
      ...
      {loading ? (
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4 mb-8">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="aspect-square bg-gray-200 rounded-lg animate-pulse overflow-hidden">
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center mb-8">
          ...
          <h3 className="text-lg font-medium text-red-800 mb-2">Unable to load Instagram content</h3>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-10 text-center mb-8">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-gray-400 mx-auto mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
          </svg>
          <h3 className="text-lg font-medium text-gray-700 mb-2">No Instagram posts yet</h3>
          <p className="text-gray-500">Check back later for updates or follow us on Instagram!</p>
        </div>
      ) : (
          ...
          {displayMoments.map((moment) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 flex items-center justify-center transition-all duration-300 opacity-0 group-hover:opacity-100">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-white opacity-0 group-hover:opacity-100 transform scale-75 group-hover:scale-100 transition-all duration-300" viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="text-center">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center justify-center bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-3 rounded-full shadow-lg hover:shadow-xl transform transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
        >
