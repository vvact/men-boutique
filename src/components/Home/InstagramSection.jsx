      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="text-base text-navy-100 max-w-2xl mx-auto">
            Stay updated with our latest products and collections. Tag us with <span className="text-gold-500 font-medium">#Manwell</span> for a chance to be featured!
          </p>
        </div>
