    ...
    <section className="py-12 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-3">New Arrivals</h2>
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 rounded-xl p-8 text-center max-w-2xl mx-auto">
            ...
            <h3 className="text-lg font-medium text-red-800 mb-2">Unable to load new arrivals</h3>
        ...
        {!loading && !error && products.length === 0 && (
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-10 text-center max-w-2xl mx-auto">
            ...
            <h3 className="text-lg font-medium text-gray-700 mb-2">No new arrivals yet</h3>
